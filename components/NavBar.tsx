...
export default function Navbar() {
  ...
  return (
    <nav style={{
      ...
      <div style={{ maxWidth: '80rem', margin: '0 auto', padding: `${theme.spacing.sm} ${theme.spacing.md}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        {/* App Logo */}
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: theme.spacing.md, opacity: 1, transition: 'opacity 0.3s ease', cursor: 'pointer' }} onMouseEnter={(e) => (e.currentTarget.style.opacity = '0.8')} onMouseLeave={(e) => (e.currentTarget.style.opacity = '1')}>
          <span style={{ fontSize: '1.5rem', fontWeight: 'bold', fontFamily: 'Georgia, serif', color: theme.colors.primary }}>
            The Loom
          </span>
        </Link>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: theme.spacing.md }}>
          ...
          <button
            ...
            style={{
              ...
              boxShadow: `0 4px 12px rgba(${theme.colors.primary === '#8C3131' ? '140, 49, 49' : '184, 74, 74'}, 0.3)`,
              fontSize: theme.colors.text.primary
            }}
            onMouseEnter={(e) => {
      ...
      {isMobile && (
        <div style={{ maxWidth: '80rem', margin: '0 auto', padding: `${theme.spacing.md} ${theme.spacing.lg}`, display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
      ...
      <style>{`
        ...
        .slider:before {
          ...
          box-shadow: inset 8px -4px 0px 0px ${theme.colors.text.primary};
        }
        ...
        .switch input:checked + .slider:before {
          ...
          box-shadow: inset 15px -4px 0px 15px ${theme.colors.background.highlight};
        }
