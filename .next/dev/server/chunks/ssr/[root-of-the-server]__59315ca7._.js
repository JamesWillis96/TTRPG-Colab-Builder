...
"[project]/Documents/TTRPG-Colab-Builder/app/signup/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        ...
        try {
            ...
            const { data, error: signUpError } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TTRPG$2d$Colab$2d$Builder$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                email,
                password
            });
            ...
            if (data.user) {
                const { error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TTRPG$2d$Colab$2d$Builder$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').update({
                    username
                }).eq('id', data.user.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59315ca7._.js.map