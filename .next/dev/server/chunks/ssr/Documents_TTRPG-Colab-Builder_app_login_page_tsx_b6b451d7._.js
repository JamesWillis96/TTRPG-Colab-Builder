...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setLoading(true);
        try {
            const { error: signInError } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TTRPG$2d$Colab$2d$Builder$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
...
//# sourceMappingURL=Documents_TTRPG-Colab-Builder_app_login_page_tsx_b6b451d7._.js.map